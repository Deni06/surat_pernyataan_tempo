            ...
            <div class="panel-body">
              <div class="panel panel-default">                
                ...
                <div class="container mb-4" style="width: 100%">
                    ...
                    <button style="font-family:montserrat;border: 2px solid #455a64;" class="btn" onclick="location.href='<?=site_url('admin/declaration_form/')?>'"><i class="fa fa-reply" style="margin-right: 4%;"></i>BACK TO LIST</button>
                    </div>                  
