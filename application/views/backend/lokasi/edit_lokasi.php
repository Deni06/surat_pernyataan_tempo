...
<meta charset="utf-8">
    ...
    <title>Update Location - Tempo Scan Tower</title>
...
<div id="container" class="effect mainnav-lg">
      ...
      <div id="page-content">
                <div class="panel panel-primary"> 
                    <div class="panel-heading" style="background: #455a64">
                        <h3 class="panel-title"><b>Update Location QR Code</b></h3>
                    </div>
                    <div class="panel-body">
                    <form role="form" method="POST" action="<?php echo site_url('admin/location/update/'.$me['lokasi_id']); ?>" onsubmit="return submitform()">
                        <div class="row">
                <!-- body items -->
                        ...
                        <div class="panel-body">
                          ...
                          ?>
                            ...
                            <div class="form-group" style="margin-bottom:3%;">
                                ...
                                <input type="text" name="nama_lokasi" placeholder="Location Name" value="<?php echo ($this->input->post('nama_lokasi') ? $this->input->post('nama_lokasi') : $me['nama_lokasi']); ?>" class="form-control" id="usr_fullname" required/>
                                </div>                                                                                
                                ...
                                <div class="row" style="margin-left: 0">
                                  ...
                                  <?php
                                $valueCheckIn = ($this->input->post('generate_checkin') ? $this->input->post('generate_checkin') : $me['is_image_checkin']);                                
                                $checkedCheckIn = "";                                                             
                                ...
                                $valueCheckOut = ($this->input->post('generate_checkout') ? $this->input->post('generate_checkout') : $me['is_image_checkout']);                                
                                $checkedCheckOut = "";                                                             

                                if($valueCheckOut == 1){
                                  $checkedCheckOut = "checked";
                                }

                                $valueEmergencyGate = ($this->input->post('is_emergency_gate') ? $this->input->post('generate_checkin') : $me['is_emergency_gate']);                                
                                $checkedEmergencyGate = "";                                                             

                                if($valueEmergencyGate == 1){
                                  $checkedEmergencyGate = "checked";
                                }
                                
                                 ?>
                                    <input type="checkbox" class="hidden-box" id="is_check_in" name="generate_checkin" value="1" <?=$checkedCheckIn?>/>
    ...
    <input type="checkbox" class="hidden-box" id="second" name="generate_checkout" value="1" <?=$checkedCheckOut?>/>
      ...
      <span class="check--label-box" style="margin-left:0;"></span> <label style="font-size:0.7em;margin-bottom:0"><b>Check Out</b></label>
                                  ...
                                  <input type="checkbox" class="hidden-box" id="is_emergency_gate" name="is_emergency_gate" value="1" <?=$checkedEmergencyGate?>/>
      ...
      <span class="check--label-box" style="margin-left:0;"></span> <label style="font-size:0.7em;margin-bottom:0"><b>Is Emergency Gate</b></label>
                                    ...
                                    <button type="submit" name="submit" style="background: #455a64; color:white;font-family:montserrat; margin-right: 20px" class="btn col-md-5">  UPDATE  <i class="fa fa-save" ></i></button>
